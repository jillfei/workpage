...
大模型往往知道大量知识，但未必知道你的事情具体应该怎么做，比如它知道 SQL，但它不知道你公司的：
...
打开左侧“技能”菜单，可以从技能市场、系统内置、企业技能等栏目搜索技能使用。


![](./images/image-1786426506285.png)


也可以在SkillHub（<https://skillhub.cn/skills>）技能市场里找到合适的Skill

![](./images/image-1786521055301.png)
...
比如你在网上看到一个好用的技能包，下载下来是一个 zip 压缩文件，操作流程是这样的：点击"上传技能"，把 zip 文件加载即可；或者直接复制skill.md的URL，通过URL进行安装；

![](./images/image-1786426564108.png)



![](./images/image-1786521588025.png)


![](./images/image-1786521669449.png)
...
比如，你编写了一份报告，需要检查报告中的错别字，你可以找到“word文档”Skill，安装之后，使用时，直接 “/” 可以换出。

![](./images/image-1786430212337.png)


你选择技能后，把任务要求写进会话窗口，AI会自动使用技能执行任务。

![](./images/image-1786430447802.png)


OmniX 会先加载skill，根据skill中的规则来执行任务

![](./images/image-1786496643617.png)

任务执行完毕后，发现不仅把错别字检查出来，而且会自动检查文档中错漏部分，包括章节编号错误等。

![](./images/image-1786496705782.png)

## Skill的关闭和卸载

打开左侧“技能”菜单，在页面中点击“已安装”标签页

![](./images/image-1786523365558.png)

通过关闭开关可以关闭skill在聊天

![](./images/image-1786523486111.png)

点击“···”，可以选择使用或卸载该Skill

![](./images/image-1786523597410.png)