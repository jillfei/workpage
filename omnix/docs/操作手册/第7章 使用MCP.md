...
**当前MCP市场已自动集成博查、ECharts图表、modelscope、高德地图、医学术语查询等MCP。**

![](./images/image-1786624555874.png)

找到想要的MCP，点击右侧添加按钮即可自动添加，比如加载博查MCP。

![](./images/image-1786624582675.png)

添加完成后，即可在会话中自动使用MCP  
![](./images/image-1786625148412.png)

## 新建MCP

在左侧菜单点击“MCP”，右上角点“添加服务器”，按引导配置 MCP（含传输协议、服务地址）。

![](./images/image-1786625323725.png)

添加成功后，可在详情页，查看该MCP的所有工具列表。

![](./images/image-1786625376480.png)